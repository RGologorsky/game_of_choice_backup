...
def get_evolution_avgs(num_timesteps, params_dict, b1, spe_d):
    ...
    # define, set before for loop, update each time a mutant fixates
    host_d = {}
    ...
    # host dictionry initial
    prior_host_start_ts = 0
    host_d[curr_host] = 0
    ...
    for timestep in range(num_timesteps):
        ...
        if does_mutant_fixate(N, beta, pi_xx, pi_xy, pi_yx, pi_yy, random_float):
            ...
            # update host dict
            host_d[curr_host] += (timestep - prior_host_start_ts)
    ...
    # update host dict
    host_d[curr_host] += (num_timesteps - prior_host_start_ts)
    ...
    return g1_cc_avg/float(num_timesteps), g2_cc_avg/float(num_timesteps), \
           ...
           spe_list_avg/float(num_timesteps), host_d
